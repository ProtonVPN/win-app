...
namespace ProtonVPN.Service.Test.SplitTunnel
{
    [TestClass]
    public class SplitTunnelTest
    {
        ...
        public void OnVpnConnecting_WhenBlockMode_DisableReversed()
        {
            ...
            var splitTunnel = GetSplitTunnel(false, true);
        ...
        public void OnVpnConnecting_WhenBlockMode_Disable()
        {
            ...
            var splitTunnel = GetSplitTunnel(true);
        ...
        {
            // Arrange
            var addresses = new[] { "127.0.0.1", "192.168.0.1", "8.8.8.8" };
            _serviceSettings.SplitTunnelSettings.Returns(new SplitTunnelSettingsContract
            {
                Mode = SplitTunnelMode.Block,
                Ips = addresses,
            ...
            var splitTunnel = GetSplitTunnel();
        ...
        {
            return new SplitTunneling.SplitTunnel(
                enabled,
                reverseEnabled,
                _serviceSettings,
                _splitTunnelClient,
