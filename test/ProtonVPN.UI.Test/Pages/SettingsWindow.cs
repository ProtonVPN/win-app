...
namespace ProtonVPN.UI.Test.Pages
{
    public class SettingsWindow
    {
        ...
        {
            UIActions.ClickOnObjectWithName("General");
            return this;
        }

        public SettingsWindow ClickConnectionTab()
        {
            UIActions.ClickOnObjectWithName("Connection");
            return this;
        }

        public SettingsWindow ClickAdvancedTab()
        {
            UIActions.ClickOnObjectWithName("Advanced");
            return this;
        }

        public SettingsWindow VerifySettingsAreDisplayed()
        {
