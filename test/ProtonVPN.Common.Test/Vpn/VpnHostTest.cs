...
namespace ProtonVPN.Common.Test.Vpn
{
    ...
    public class VpnHostTest
    {
        ...
        public void Name_ShouldBe_Name()
        {
            ...
            var host = new VpnHost(expected, "127.0.0.1", string.Empty, null, string.Empty);
        ...
        public void Ip_ShouldBe_Ip()
        {
            ...
            var host = new VpnHost("server-1.protonvpn.com", expected, string.Empty, null, string.Empty);
        ...
        {
            // Arrange
            var host = new VpnHost("name.com", "0.0.0.0", string.Empty, null, string.Empty);
