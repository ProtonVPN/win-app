...
public class IllustratedHyperlinkButton : HyperlinkButton
{
    public static readonly DependencyProperty IllustrationSourceProperty =
        DependencyProperty.Register(nameof(IllustrationSource), typeof(ImageSource), typeof(IllustratedHyperlinkButton), new PropertyMetadata(default));
