...
public class BulletContentControl : ContentControl
{
    public static readonly DependencyProperty BulletContentProperty =
        DependencyProperty.Register(nameof(BulletContent), typeof(object), typeof(BulletContentControl), new PropertyMetadata(default));
    ...
    {
        DefaultStyleKey = typeof(BulletContentControl);
    }
}