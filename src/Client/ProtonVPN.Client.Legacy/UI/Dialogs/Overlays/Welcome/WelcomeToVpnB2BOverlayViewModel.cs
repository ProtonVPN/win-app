...
public class WelcomeToVpnB2BOverlayViewModel : OverlayViewModelBase
{
    public WelcomeToVpnB2BOverlayViewModel(ILocalizationProvider localizationProvider, ILogger logger,
