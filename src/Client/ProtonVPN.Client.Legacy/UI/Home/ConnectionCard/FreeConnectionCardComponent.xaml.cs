...
public sealed partial class FreeConnectionCardComponent
{
    public FreeConnectionCardViewModel ViewModel { get; }

    public FreeConnectionCardComponent()
    {
        ViewModel = App.GetService<FreeConnectionCardViewModel>();
        InitializeComponent();
    }
