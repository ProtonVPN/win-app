...
public class SidebarSplitTunnelingViewModel : SidebarFeatureNavigationItemViewModelBase<SplitTunnelingViewModel>
{
    ...
    protected override ModalSources UpsellModalSource => ModalSources.SplitTunneling;

    public override string AutomationId => "Sidebar_Features_SplitTunneling";

    public SidebarSplitTunnelingViewModel(
    ...
    protected override void OnSettingsChanged(string propertyName)
    {
        ...
        switch (propertyName)
        {
            ...
            case nameof(ISettings.SplitTunnelingMode):
