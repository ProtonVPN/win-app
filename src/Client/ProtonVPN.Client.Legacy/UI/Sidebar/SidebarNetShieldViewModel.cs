...
public class SidebarNetShieldViewModel : SidebarFeatureNavigationItemViewModelBase<NetShieldViewModel>
{
    ...
    protected override ModalSources UpsellModalSource => ModalSources.NetShield;

    public override string AutomationId => "Sidebar_Features_NetShield";

    public SidebarNetShieldViewModel(
