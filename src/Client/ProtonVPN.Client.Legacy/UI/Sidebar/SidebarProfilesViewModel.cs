...
public class SidebarProfilesViewModel : SidebarNavigationItemViewModelBase<ProfilesPageViewModel>
{
    public override IconElement? Icon { get; } = new WindowTerminal();

    public override string Header => Localizer.Get("Profiles_Page_Title");

    public override string AutomationId => "Sidebar_Profiles";
