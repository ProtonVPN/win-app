...
public class SidebarHomeViewModel : SidebarNavigationItemViewModelBase<HomeViewModel>
{
    public override IconElement? Icon { get; } = new House();

    public override string Header => Localizer.Get("Home_Page_Title");

    public override string AutomationId => "Sidebar_Home";

    public SidebarHomeViewModel(
