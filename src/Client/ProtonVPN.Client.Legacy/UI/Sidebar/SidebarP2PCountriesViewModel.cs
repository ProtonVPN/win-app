...
public class SidebarP2PCountriesViewModel : SidebarNavigationItemViewModelBase<P2PCountriesPageViewModel>
{
    public override IconElement? Icon { get; } = new ArrowRightArrowLeft();

    public override string Header => Localizer.Get("Countries_P2P");

    public override string AutomationId => "Sidebar_Countries_P2P";

    public override bool RequiresPaidAccess => true;

    public SidebarP2PCountriesViewModel(
