...
public sealed partial class RecentsPageView : IContextAware
{
    public RecentsPageViewModel ViewModel { get; }

    public RecentsPageView()
    {
        ViewModel = App.GetService<RecentsPageViewModel>();
