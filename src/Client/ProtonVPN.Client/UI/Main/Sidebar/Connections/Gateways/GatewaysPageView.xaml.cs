...
public sealed partial class GatewaysPageView : IContextAware
{
    public GatewaysPageViewModel ViewModel { get; }

    public GatewaysPageView()
    {
        ViewModel = App.GetService<GatewaysPageViewModel>();
