...
public sealed partial class SearchResultsPageView : IContextAware
{
    public SearchResultsPageViewModel ViewModel { get; }

    public SearchResultsPageView()
    {
        ViewModel = App.GetService<SearchResultsPageViewModel>();
