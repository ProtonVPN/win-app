...
public sealed partial class CensorshipSettingsPageView : IContextAware
{
    public CensorshipSettingsPageViewModel ViewModel { get; }

    public CensorshipSettingsPageView()
    {
        ViewModel = App.GetService<CensorshipSettingsPageViewModel>();
