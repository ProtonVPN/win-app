...
public sealed partial class VpnAcceleratorSettingsPageView : IContextAware
{
    public VpnAcceleratorSettingsPageViewModel ViewModel { get; }

    public VpnAcceleratorSettingsPageView()
    {
        ViewModel = App.GetService<VpnAcceleratorSettingsPageViewModel>();
