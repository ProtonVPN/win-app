...
public sealed partial class NetShieldPageView : IContextAware
{
    public NetShieldPageViewModel ViewModel { get; }

    public NetShieldPageView()
    {
        ViewModel = App.GetService<NetShieldPageViewModel>();
