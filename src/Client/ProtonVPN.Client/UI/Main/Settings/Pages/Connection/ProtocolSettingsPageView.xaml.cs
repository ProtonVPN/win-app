...
public sealed partial class ProtocolSettingsPageView : IContextAware
{
    public ProtocolSettingsPageViewModel ViewModel { get; }

    public ProtocolSettingsPageView()
    {
        ViewModel = App.GetService<ProtocolSettingsPageViewModel>();
