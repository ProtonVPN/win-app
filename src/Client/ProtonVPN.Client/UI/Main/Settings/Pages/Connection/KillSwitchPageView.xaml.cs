...
public sealed partial class KillSwitchPageView : IContextAware
{
    public KillSwitchPageViewModel ViewModel { get; }

    public KillSwitchPageView()
    {
        ViewModel = App.GetService<KillSwitchPageViewModel>();
