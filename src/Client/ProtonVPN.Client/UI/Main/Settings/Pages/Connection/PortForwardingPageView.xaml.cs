...
public sealed partial class PortForwardingPageView : IContextAware
{
    public PortForwardingPageViewModel ViewModel { get; }

    public PortForwardingPageView()
    {
        ViewModel = App.GetService<PortForwardingPageViewModel>();
