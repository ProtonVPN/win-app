...
public sealed partial class AdvancedSettingsPageView : IContextAware
{
    public AdvancedSettingsPageViewModel ViewModel { get; }

    public AdvancedSettingsPageView()
    {
        ViewModel = App.GetService<AdvancedSettingsPageViewModel>();
