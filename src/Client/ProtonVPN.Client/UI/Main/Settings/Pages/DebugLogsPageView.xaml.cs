...
public sealed partial class DebugLogsPageView : IContextAware
{
    public DebugLogsPageViewModel ViewModel { get; }

    public DebugLogsPageView()
    {
        ViewModel = App.GetService<DebugLogsPageViewModel>();
