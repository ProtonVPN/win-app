...
public partial class SplitTunnelingPageViewModel : FeaturePageViewModelBase
{
    ...
    public SplitTunnelingPageViewModel(
        ...
        : base(parentViewNavigator, localizer, logger, issueReporter, mainWindowOverlayActivator, settings,
            settingsConflictResolver, connectionManager, ConnectionFeature.SplitTunneling)
    {
        _urls = urls;
    ...
    public async Task AddAppAsync()
    {
        ...
        string filePath = await _mainWindowActivator.Window.PickSingleFileAsync(Localizer.Get("Settings_Features_SplitTunneling_Apps_FilesFilterName"), [EXE_FILE_EXTENSION]);
