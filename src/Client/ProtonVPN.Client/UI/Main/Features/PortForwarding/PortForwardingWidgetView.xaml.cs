...
public sealed partial class PortForwardingWidgetView : IContextAware
{
    public PortForwardingWidgetViewModel ViewModel { get; }

    public PortForwardingWidgetView()
    {
        ViewModel = App.GetService<PortForwardingWidgetViewModel>();
