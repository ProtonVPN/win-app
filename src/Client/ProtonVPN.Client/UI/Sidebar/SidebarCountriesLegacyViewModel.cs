...
public class SidebarCountriesLegacyViewModel : SidebarNavigationItemViewModelBase<CountriesViewModel>
{
    public override IconElement? Icon { get; } = new Earth();

    public override string Header => "Countries (legacy)";

    public override string AutomationId => "Sidebar_Countries_All";

    public override bool RequiresPaidAccess => true;

    public SidebarCountriesLegacyViewModel(
