...
public class SidebarGalleryViewModel : SidebarNavigationItemViewModelBase<GalleryViewModel>
{
    public override IconElement? Icon { get; } = new Grid2();

    public override string Header => "Gallery";

    public override bool IsVisible => Settings.IsDebugModeEnabled;

    public override string AutomationId => "Sidebar_Gallery";

    public SidebarGalleryViewModel(
    ...
    protected override void OnSettingsChanged(string propertyName)
    {
        ...
        if (propertyName == nameof(ISettings.IsDebugModeEnabled))
        {
