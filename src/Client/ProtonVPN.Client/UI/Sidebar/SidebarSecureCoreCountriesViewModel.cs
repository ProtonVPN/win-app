...
public class SidebarSecureCoreCountriesViewModel : SidebarNavigationItemViewModelBase<SecureCoreCountriesPageViewModel>
{
    public override IconElement? Icon { get; } = new LockLayers();

    public override string Header => Localizer.Get("Countries_SecureCore");

    public override string AutomationId => "Sidebar_Countries_SecureCore";

    public override bool RequiresPaidAccess => true;

    public SidebarSecureCoreCountriesViewModel(
