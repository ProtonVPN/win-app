...
public partial class ShellViewModel : ShellViewModelBase<IMainViewNavigator>, IEventMessageReceiver<LoggedInMessage>
{
    ...
    public ShellViewModel(
        ...
        SidebarCountriesLegacyViewModel sidebarCountriesLegacy,
        SidebarCountriesViewModel sidebarCountries,
        SidebarSecureCoreCountriesViewModel sidebarSecureCoreCountries,
        SidebarP2PCountriesViewModel sidebarP2PCountries,
        SidebarTorCountriesViewModel sidebarTorCountries,
        ...
        : base(viewNavigator, localizationProvider, logger, issueReporter)
    {
        ...
        MenuItems = new()
        {
            ...
            sidebarCountriesLegacy,
            sidebarCountries,
            sidebarSecureCoreCountries,
            sidebarP2PCountries,
            sidebarTorCountries,
