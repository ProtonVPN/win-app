...
{
    public class CustomDnsUpsellModalViewModel : UpsellModalViewModel
    {
        protected override ModalSources ModalSource { get; } = ModalSources.CustomDns;

        public CustomDnsUpsellModalViewModel(ISubscriptionManager subscriptionManager, ServerManager serverManager,
