...
namespace ProtonVPN.FlashNotifications
{
        ...
        ILogoutAware
    {
        ...
        public FlashNotificationViewModel(
        ...
        public void OnWifiChangeDetected(string name, bool secure)
        {
            if (!secure)
            {
                _insecureWifiNotificationViewModel.Name = name;
                ShowMessage(_insecureWifiNotificationViewModel);
            }
            else
            {
                CloseMessage(_insecureWifiNotificationViewModel);
            }
        }
