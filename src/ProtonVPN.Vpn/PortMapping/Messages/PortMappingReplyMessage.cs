...
{
    public class PortMappingReplyMessage : ReplyMessageBase
    {
        public int Length => 16;
        
        public ushort ResultCode { get; set; }
        public uint StartOfEpochSecond { get; set; }
        ...
        {
            return ResultCode == 0 &&
                   (Operation == REPLY_FLAG + (byte)TransportProtocol.TCP ||
                    Operation == REPLY_FLAG + (byte)TransportProtocol.UDP);
        }
    }
}