...
namespace ProtonVPN.Vpn.NetworkAdapters
{
    public class WintunAdapter
    {
        ...
        public WintunAdapter(ILogger logger, IConfiguration config)
        {
            _logger = logger;
            _config = config;
        ...
        public bool Create()
        {
            ...
            _adapterHandle = WintunOpenAdapter(_config.WintunAdapterName);
        ...
        private void InitializeLibrary()
        {
            if (_libraryHandle == IntPtr.Zero)
            {
                _libraryHandle = LoadLibrary(_config.WintunDriverPath);
            }
        }
