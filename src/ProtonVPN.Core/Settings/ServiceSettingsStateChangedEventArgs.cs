...
{
    public class ServiceSettingsStateChangedEventArgs
    {
        public bool IsNetworkBlocked { get; }
        public VpnStateChangedEventArgs CurrentState { get; }

        public ServiceSettingsStateChangedEventArgs(bool isNetworkBlocked, VpnStateChangedEventArgs currentState)
        {
