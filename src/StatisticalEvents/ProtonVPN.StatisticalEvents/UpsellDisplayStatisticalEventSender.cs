...
{
    public class UpsellDisplayStatisticalEventSender : StatisticalEventSenderBase<UpsellMeasurementGroup>,
        IUpsellDisplayStatisticalEventSender
    {
        public override string Event => "upsell_display";
        ...
        public UpsellDisplayStatisticalEventSender(IUpsellDimensionBuilder upsellDimensionBuilder,
