...
namespace ProtonVPN.ProTun.Dns;

public class ProTunDnsServersCreator : IProTunDnsServersCreator
{
    private readonly IAdapterDetailsCache _adapterDetailsCache;

    public ProTunDnsServersCreator(IAdapterDetailsCache adapterDetailsCache)
    {
    ...
    public IReadOnlyList<string> GetDnsServers(IReadOnlyCollection<string> customDns, bool isIpv6Supported)
    {
        ...
        dnsAddresses.Add(_adapterDetailsCache.ServerGatewayIpv4Address);
