...
namespace ProtonVPN.Common.Configuration
{
    public interface IConfiguration
    {
        ...
        [Range(typeof(TimeSpan), "00:00:10", "23:59:59")]
        TimeSpan FeatureFlagsUpdateInterval { get; set; }
        ...
        [Required]
        int[] DefaultWireGuardTcpPorts { get; set; }

        [Required]
        int[] DefaultWireGuardTlsPorts { get; set; }
        ...
        [Range(typeof(TimeSpan), "00:00:00", "23:59:59")]
        TimeSpan StatisticalEventMinimumWaitInterval { get; set; }
    }
}