...
public static class TestsSrpInvoke
{
    ...
    // Proton client has to be installed in order to get go.srp file.
    private static string BinaryPath => Path.Combine(TestEnvironment.GetProtonClientFolder(), "Resources", "GoSrp.dll");
