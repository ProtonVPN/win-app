...
Source: "..\src\bin\ProtonVPN.Common.Core.dll"; DestDir: "{app}\{#VersionFolder}"; Flags: signonce;
Source: "..\src\bin\ProtonVPN.Common.Core.deps.json"; DestDir: "{app}\{#VersionFolder}";
...
Source: "..\src\bin\ProtonVPN.Common.UI.dll"; DestDir: "{app}\{#VersionFolder}"; Flags: signonce;
Source: "..\src\bin\ProtonVPN.Common.UI.deps.json"; DestDir: "{app}\{#VersionFolder}";
Source: "..\src\bin\ProtonVPN.Connection.dll"; DestDir: "{app}\{#VersionFolder}"; Flags: signonce;
Source: "..\src\bin\ProtonVPN.Connection.deps.json"; DestDir: "{app}\{#VersionFolder}";
Source: "..\src\bin\ProtonVPN.Connection.Contracts.dll"; DestDir: "{app}\{#VersionFolder}"; Flags: signonce;
Source: "..\src\bin\ProtonVPN.Connection.Contracts.deps.json"; DestDir: "{app}\{#VersionFolder}";
Source: "..\src\bin\ProtonVPN.Connection.Installers.dll"; DestDir: "{app}\{#VersionFolder}"; Flags: signonce;
Source: "..\src\bin\ProtonVPN.Connection.Installers.deps.json"; DestDir: "{app}\{#VersionFolder}";
